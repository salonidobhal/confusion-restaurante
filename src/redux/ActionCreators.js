...
export const fetchLeaders = () => (dispatch) => { //thunk that returns a function used to call or dispatch several actions
...
export const leadersLoading = () => ({ // the three methods below return an object
